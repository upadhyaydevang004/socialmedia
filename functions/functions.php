<?php 
	$con = mysqli_connect("sql109.epizy.com","epiz_21651871","Devang10","epiz_21651871_social_network") or die("Connection was not established");
		...
		$get_trusts = "select * from trusts"; 
		
		$run_trusts = mysqli_query($con,$get_trusts);
					
		while($row=mysqli_fetch_array($run_trusts)){
						
		$trust_id = $row['trust_id'];
		$trust_name = $row['trust_name'];
					
		echo "<option value='$trust_id'>$trust_name</option>";
			}
		}
		...
		function insertPost(){
			...
			$insert = "insert into posts (user_id,topic_id,trust_id,post_title,post_content,post_date) values ('$user_id','$topic','$trust','$title','$content',NOW())";
	...
	$get_posts = "select * from posts where trust_id='2' ORDER by 1 DESC LIMIT $start_from, $per_page";
	...
	$get_posts = "select * from posts where user_id='$u_id' AND trust_id='1' ORDER by 1 DESC LIMIT 5";
	...
	$get_posts = "select * from posts where user_id='$u_id' AND trust_id='2' ORDER by 1 DESC LIMIT 5";
	...
	$get_posts = "select * from posts where user_id='$u_id' AND trust_id='3' ORDER by 1 DESC LIMIT 5";
